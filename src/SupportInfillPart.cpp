...
SupportInfillPart::SupportInfillPart(const PolygonsPart& outline, coord_t support_line_width, bool use_fractional_config, size_t extruder_nr, int inset_count_to_generate, coord_t custom_line_distance)
    : outline(outline)
